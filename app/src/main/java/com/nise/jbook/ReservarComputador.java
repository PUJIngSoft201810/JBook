...
import com.nise.jbook.Objetos.AdapterComputador;
import com.nise.jbook.Objetos.Computador;
import com.nise.jbook.Objetos.FirebaseReferences;
import com.nise.jbook.Objetos.Reserva;
import com.nise.jbook.Objetos.TipoComputador;
        ...
        buttonReserva.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                for(int i = 0; i < computadores.size(); i++)
                {
                    ...
                    if(computadores.get(i).getId().equals(textId))
                    {
